...
function getPlatformMessengerEnabled() { return !!getPlatformFbPageId() && !!getPlatformFbPageAccessToken(); }
function isPlatformPage(pageId: string): boolean { return !!getPlatformFbPageId() && String(pageId) === getPlatformFbPageId(); }
