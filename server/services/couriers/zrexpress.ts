...
export class ZRExpressOfficialService implements CourierService {
  ...
  private mapStatus(zrStatus: string): string {
    ...
    const statusMap: Record<string, string> = {
      ...
      'order_in_process': 'in_transit',
      'confirmation_call': 'pending',
      'order_confirmed': 'pending',
      'ready_to_ship': 'pending',
      'confirmed_at_office': 'pending',
      'dispatch_in_the_same_wilaya': 'in_transit',
      'to_region': 'in_transit',
      'picked_up': 'picked_up',
      'in_transit': 'in_transit',
      'at_hub': 'in_transit',
      'out_for_delivery': 'out_for_delivery',
      'out_for_delivery_again': 'out_for_delivery',
