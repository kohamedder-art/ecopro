...
export async function handleCustomerMessage(
  ...
  const CHECKOUT_KEYWORDS = ['كوموندي', 'نكوموندي', 'شري', 'اشري', 'سجل', 'حبة', 'حبات', 'المقاس', 'مقاس', 'نطلب', 'اطلب', 'نريد', 'اريد', 'نخshi', 'نخши'];
  const isCheckoutIntent = CHECKOUT_KEYWORDS.some(keyword => msg.includes(keyword));
