...
export function normalizeTemplateId(id: string): string {
    ...
    const validIds = ['dzshop', 'needdz', 'zenith', 'boutique', 'iyco', 'bassem28', 'spiriluxe', 'leroishop'];
...
export { DZShopTemplate, NeedDZTemplate, ZenithTemplate, BoutiqueTemplate, IycoTemplate, Bassem28Template, SpiriluxeTemplate, LeRoiShopTemplate };
