      ...
      <div className="relative pt-32 pb-16 px-6 overflow-hidden z-10 w-full">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <div className="text-center mb-16">
            <div className="inline-flex items-center space-x-2 space-x-reverse bg-emerald-50 border border-emerald-100 px-3 py-1.5 rounded-full mb-6">
              <Sparkles className="w-4 h-4 text-emerald-500" />
              <span className="text-xs font-bold text-emerald-700 dark:text-emerald-300">منصتكم، قصتكم</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-black mb-6 tracking-tight text-slate-900 dark:text-white leading-tight">
              Sahla4Eco: التجارة الإلكترونية للجميع، <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-emerald-400">وليس للقلة</span>
            </h1>
          </div>

          {/* Story Section */}
          <div className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-md border border-slate-200 dark:border-slate-700 shadow-sm rounded-3xl p-8 md:p-10 mb-12 hover:border-emerald-200 dark:hover:border-emerald-700 hover:shadow-md transition-all">
          ...
          {/* Vision Section */}
          <div className="bg-gradient-to-br from-emerald-900 to-slate-900 text-white rounded-3xl p-8 md:p-10 mb-12 shadow-xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg leading-loose text-emerald-100">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-16">
            <div className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-md border border-slate-200 dark:border-slate-700 shadow-sm rounded-2xl p-6 hover:-translate-y-1 hover:shadow-lg hover:border-emerald-200 dark:hover:border-emerald-700 transition-all duration-300">
          ...
          <div className="text-center rounded-3xl p-10 bg-gradient-to-br from-emerald-900 to-slate-900 text-white shadow-xl relative overflow-hidden">
            <div className="absolute top-0 right-0 w-64 h-64 bg-emerald-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse"></div>
            <div className="relative z-10">
              <h2 className="text-2xl md:text-3xl font-black mb-4">انضم إلى الثورة</h2>
              <p className="text-emerald-100 font-medium max-w-2xl mx-auto mb-8 leading-relaxed text-lg">
