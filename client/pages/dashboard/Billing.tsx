      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          {subLoading ? (
            ...
            <>
              ...
              <div className="p-3 flex items-center gap-3">
                ...
                {(subscription.status === 'active' || subscription.status === 'trial' || subscription.status === 'extended') && (
        ...
        <div className={`${surfaceCard} overflow-hidden flex flex-col`}>
          <div className="p-4 text-center border-b border-slate-200/70 dark:border-slate-700/60">
            ...
            <p className="text-4xl font-black bg-gradient-to-r from-violet-600 to-fuchsia-600 bg-clip-text text-transparent">{subscriptionPrice} <span className="text-lg">{t('pricing.currency')}</span></p>
