...
import { surfaceCard, fmtNum, fmtCurrency, fmtPoas, fmtPct, frictionColor } from './helpers';
import { useTranslation } from '@/lib/i18n';
import { MkrMegaphone, MkrAlert, MkrChevron, MkrDollar, MkrTrend } from '@/components/icons/MarketingIcons';
...
export function CreativesTab({ creatives, toxicCreativeCount }: CreativesTabProps) {
  const { t } = useTranslation();
  const [expandedCreative, setExpandedCreative] = useState<string | null>(null);

  return (
    <TabShell
      isEmpty={creatives.length === 0}
