...
echo "2. Copy the 'Internal Database URL'postgresql://sahla4eco_db_user:FLDPHutpZp8DYg0gV8gfVGgOHcSdQ95k@dpg-d5l1upngi27c738gvr1g-a.oregon-postgres.render.com/sahla4eco_db"
# JWT Security
echo "3. Add to .env.local: DATABASE_URL=postgresql://sahla4eco_db_user:FLDPHutpZp8DYg0gV8gfVGgOHcSdQ95k@dpg-d5l1upngi27c738gvr1g-a.oregon-postgres.render.com/sahla4eco_dbpostgresql://sahla4eco_db_user:FLDPHutpZp8DYg0gV8gfVGgOHcSdQ95k@dpg-d5l1upngi27c738gvr1g-a.oregon-postgres.render.com/sahla4eco_db"
echo "4. Run: pnpm dev"
echo ""
